REM Installs Mada's IntelliJ configs into your user configs.
@echo off
echo Installing Mada IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Mada' or 'MadaAndroid'.
exit /b
